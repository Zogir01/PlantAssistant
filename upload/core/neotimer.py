# This file is based on the original file "neotimer.py" from the project:
#
# "micropython_neotimer" by jrullan
#   https://github.com/jrullan/micropython_neotimer/tree/main
#
# Original code copyright: (c) 2022 Jose Rullan.
# Licensed under Apache License, Version 2.0 (see below)
#
